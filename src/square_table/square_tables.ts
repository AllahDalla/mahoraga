export const pawnSquareValues: Record<string, number> = {
    // Rank 8 (top row)
...
export const knightSquareValues: Record<string, number> = {
    // Rank 8 (top row)
...
export const bishopSquareValues: Record<string, number> = {
    // Rank 8 (top row)
...
export const rookSquareValues: Record<string, number> = {
    // Rank 8 (top row)
    a8: 0, b8: 0, c8: 0, d8: 0, e8: 0, f8: 0, g8: 0, h8: 0,
...
export const queenSquareValues: Record<string, number> = {
    // Rank 8 (top row)
...
export const kingMiddleSquareValues: Record<string, number> = {
    // Rank 8 (top row)
...
export const kingEndSquareValues: Record<string, number> = {
    // Rank 8 (top row)
